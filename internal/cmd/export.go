...
func renderHTMLLog(project, cliVersion string, now time.Time, items []exportItem) string {
	...
	b.WriteString("    .timeline-marker{position:absolute;left:-88px;top:20px;width:22px;height:22px;border-radius:999px;border:3px solid #fff;background:#9fb0c7;box-shadow:0 0 0 2px rgba(144,160,184,.38),0 6px 14px rgba(15,23,42,.1)}\n")
	b.WriteString("    .timeline-stamp{position:absolute;left:-92px;top:52px;width:84px;font-size:.7rem;line-height:1;color:var(--text);font-weight:700;text-transform:uppercase;letter-spacing:.04em;white-space:nowrap}\n")
	...
	b.WriteString("    .timeline-entry-checkpoint .timeline-marker{left:-92px;top:14px;width:30px;height:30px;background:radial-gradient(circle at 30% 30%,#fff4c3 0%,#f2c14e 45%,#8a6610 100%);box-shadow:0 0 0 3px rgba(242,193,78,.24),0 10px 18px rgba(15,23,42,.15)}\n")
	b.WriteString("    .timeline-entry-checkpoint .timeline-stamp{top:52px;color:#6a5320}\n")
	...
	b.WriteString("    @media (max-width:760px){.timeline{padding-left:76px}.timeline::before{left:28px}.timeline-marker{left:-72px;width:20px;height:20px}.timeline-stamp{left:-76px;width:64px;font-size:.66rem}.timeline-entry-checkpoint .timeline-marker{left:-76px;width:26px;height:26px}.timeline-divider::before{left:-44px}}\n")
	b.WriteString("    @media (max-width:640px){main{padding:16px 12px 32px}header{padding:14px}.checkpoint h2{padding-right:0}.event-actions{width:100%}.timeline{padding-left:0}.timeline::before{left:12px}.timeline-marker{left:-1px;top:-6px;width:16px;height:16px;border-width:2px}.timeline-stamp{position:static;width:auto;margin:0 0 8px 30px;font-size:.72rem;font-weight:700;line-height:1.2;text-transform:none;letter-spacing:0;white-space:nowrap}.timeline-entry-checkpoint .timeline-marker{left:-5px;top:-10px;width:22px;height:22px}.timeline-entry-checkpoint .timeline-stamp{margin-left:34px}.timeline-divider::before{left:12px}}\n")
	b.WriteString("  </style>\n")
	b.WriteString("</head>\n")
	b.WriteString("<body>\n")
	b.WriteString("<main>\n")
